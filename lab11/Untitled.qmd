...
UniProtKB (the main protein sequence database) has over 200 million re
...
The EBI alphafold database contains lost of computed structure models. It is increasingly likely that the structure you are interested in is already in this database. < https://alphafold.ebi.ac.uk > 
...
## Running AlphaFold
We will use < http://github.com/sokrypton/ColabFold >
...
![HIVPr Monomer]("HIVPRMonomer.png")

![HIV Dimer Aligned to Chain A]("DimerAlignedtoA.png")

![HIV Dimer Aligned to Chain B]("DimerAlignedtoB.png")
